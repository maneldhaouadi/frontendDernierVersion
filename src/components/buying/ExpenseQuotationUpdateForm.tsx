...
export const ExpenseQuotationUpdateForm = ({ className, expensequotationId }: ExpenseQuotationFormProps) => {
  ...
  React.useEffect(() => {
    if (quotation?.sequential)
      setRoutes([
        ...
        { title: tInvoicing('quotation.plural'), href: '/buying/expense-quotations' },
  ...
  const setQuotationData = (data: Partial<ExpensQuotation & { files: ExpensQuotationUploadedFile[] }>) => {
    //quotation infos
    ...
    controlManager.setControls({
      ...
      isInvoiceAddressHidden: !data?.expenseQuotationMetaData?.showInvoiceAddress,
  ...
  const { isDisabled, globalReset } = useInitializedState({
    data: quotation || ({} as Partial<ExpensQuotation & { files: ExpensQuotationUploadedFile[] }>),
    getCurrentData: () => {
      return {
    ...
    setFormData: (data: Partial<ExpensQuotation & { files: ExpensQuotationUploadedFile[] }>) => {
