...
export const getQuotationColumns = (
  ...
  const firmColumn: ColumnDef<Quotation> = {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={translate('quotation_achat.attributes.firm')}
  ...
  const interlocutorColumn: ColumnDef<Quotation> = {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader
        column={column}
        title={translate('quotation_achat.attributes.interlocutor')}
  ...
  const columns: ColumnDef<Quotation>[] = [
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={translate('quotation_achat.attributes.number')}
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={translate('quotation_achat.attributes.date')}
      ...
      cell: ({ row }) => (
        <div>
          {row.original.date ? (
            ...
            <span>{t('quotation_achat.attributes.no_date')}</span>
          )}
        </div>
      ),
      enableSorting: true,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={translate('quotation_achat.attributes.due_date')}
      ...
      cell: ({ row }) => (
        <div>
          {row.original.dueDate ? (
            ...
            <span>{t('quotation_achat.attributes.no_due_date')}</span>
          )}
        </div>
      ),
      enableSorting: true,
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={translate('quotation_achat.attributes.status')}
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={translate('quotation_achat.attributes.total')}
    ...
    },
    {
      ...
      header: ({ column }) => (
        <DataTableColumnHeader
          column={column}
          title={translate('quotation_achat.attributes.created_at')}
