...
import { ExpenseQuotationDeleteDialog } from './expense-quotation/dialogs/ExpenseQuotationDeleteDialog';
import { ExpenseQuotationDuplicateDialog } from './expense-quotation/dialogs/ExpenseQuotationDuplicateDialog';
import { ExpenseQuotationDownloadDialog } from './expense-quotation/dialogs/ExpenseQuotationDownloadDialog';
import { ExpenseQuotationInvoiceDialog } from './expense-quotation/dialogs/ExpenseQuotationInvoiceDialog';
import { ExpenseQuotationActionsContext } from './expense-quotation/data-table/ActionsContext';
import { DataTable } from './expense-quotation/data-table/data-table';
import { getExpenseQuotationColumns } from './expense-quotation/data-table/columns';
...
export const ExpenseQuotationMain: React.FC<ExpenseQuotationMainProps> = ({ className }) => {
  ...
  React.useEffect(() => {
    setRoutes([
      ...
      { title: tCommon('submenu.expensequotations') }
    ]);
  }, [router.locale]);
