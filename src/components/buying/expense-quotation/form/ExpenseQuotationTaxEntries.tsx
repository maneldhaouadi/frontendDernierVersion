...
import { ExpensArticleQuotationEntry, Currency, Tax } from '@/types';
...
interface QuotationTaxEntriesProps {
  className?: string;
  article: ExpensArticleQuotationEntry;
  taxes: Tax[];
...
export const ExpenseQuotationTaxEntries: React.FC<QuotationTaxEntriesProps> = ({
  className,
  article,
  taxes,
  selectedTaxIds,
