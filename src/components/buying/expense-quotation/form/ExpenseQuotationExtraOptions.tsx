...
export const ExpenseQuotationExtraOptions = ({ className, loading }: ExpenseQuotationExtraOptionsProps) => {
    ...
    <Accordion type="multiple" className={cn(className, 'mx-1 border-b')}>
      <AccordionItem value="item-1">
        <AccordionTrigger>
          <div className="flex gap-2 justify-center items-center">
            <Files />
            <Label>{tInvoicing('expensequotation.attributes.files')}</Label>
          </div>
        </AccordionTrigger>
      ...
      <AccordionItem value="item-2">
        <AccordionTrigger>
          <div className="flex gap-2 justify-center items-center">
            <NotebookTabs />
            <Label>{tInvoicing('expensequotation.attributes.notes')}</Label>
          </div>
        </AccordionTrigger>
        <AccordionContent className="m-5">
          <Textarea
            placeholder={tInvoicing('expensequotation.attributes.notes')}
