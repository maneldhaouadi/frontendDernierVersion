...
interface ExpenseQuotationDeleteDialogProps {
  className?: string;
  id?: number;
  sequential: string;
  open: boolean;
  deleteExpenseQuotation: () => void;
  isDeletionPending?: boolean;
  onClose: () => void;
}

export const ExpenseQuotationDeleteDialog: React.FC<ExpenseQuotationDeleteDialogProps> = ({
  className,
  id,
  sequential,
  open,
