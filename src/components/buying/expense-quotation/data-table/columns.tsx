import { ExpensQuotation } from '@/types';
...
import { DataTableRowActions } from '@/components/administrative-tools/Logger/data-table/data-table-row-actions';
...
export const getExpenseQuotationColumns = (
  ...
  const translate = (value: string, namespace: string = '') => {
   ...
   const firmColumn: ColumnDef<ExpensQuotation> = {
    ...
    const interlocutorColumn: ColumnDef<ExpensQuotation> = {
  ...
  const columns: ColumnDef<ExpensQuotation>[] = [
    {
      accessorKey: 'number',
      header: ({ column }) => (
        <DataTableColumnHeader
